RSpec.describe Cryppo do
  ...
  aes_encryption_strategies = ['Aes256Ofb', 'Aes256Gcm']
  all_encryption_strategies = aes_encryption_strategies + ['Rsa4096']
  ...
  describe 'Cryppo.encrypt_with_derived_key' do
    ...
    let(:encrypted_data) { encrypted_data_value.encrypted_data }
    let(:decrypted_data) { encrypted_data_value.decrypt(passphrase) }
